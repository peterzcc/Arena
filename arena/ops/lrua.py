...
class LRUAHeadGroup(object):
    def __init__(self, control_state_dim, memory_size, memory_state_dim, k_smallest=1, gamma=0.9,
                 num_heads=1,
                 init_W_r_focus=None, init_W_u_focus=None,
                 is_write=False, name="LRUAHeadGroup"):
        """

        Parameters
        ----------
        control_state_dim : int
        memory_size : int
        memory_state_dim : int
        k_smallest : int, optional
            number of position to insert the new memory info
        gamma : int, optional
            decay rate of the memory
        num_heads : int, optional
            number of memory heads
        init_W_r_focus : None or mxnet.Symbol
            initial read focus of the head
        init_W_u_focus : None or mxnet.Symbol
            initial usage of the head, should be initialized as zero
        is_write:
...
class LRUA(object):
    def __init__(self, control_state_dim, memory_size, memory_state_dim, k_smallest, gamma,
        ...
        self.read_head = LRUAHeadGroup(control_state_dim=control_state_dim,
        ...
        self.write_head = LRUAHeadGroup(control_state_dim=control_state_dim,
                                        memory_size=memory_size,
                                        memory_state_dim=memory_state_dim,
                                        k_smallest=k_smallest,
