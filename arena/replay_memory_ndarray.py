...
class ReplayMemory(object):
    def __init__(self, history_length, memory_size=1000000, replay_start_size=100,
        ...
        self.actions = nd.zeros((memory_size,) + action_dim, dtype=action_dtype)
        self.rewards = nd.zeros(memory_size, dtype='float32')
        self.terminate_flags = nd.zeros(memory_size, dtype='bool')
