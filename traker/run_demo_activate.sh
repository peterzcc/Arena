...
workerq="*.q@client108,*.q@client109,*.q@client110,*.q@client111,*.q@client112,*.q@client1113,*.q@client114,*.q@client115,*.q@client108,*.q@client109,*.q@client110,*.q@client111,*.q@client112,*.q@client1113,*.q@client114,*.q@client115,"
serverq="*.q@client111,*.q@client112,*.q@client1113,*.q@client114,*.q@client115"
