...
# script="python easgd_async.py -r roms/breakout.bin -d easgdfixt --replay-start-size 90 --optimizer rmspropnoncentered --lr 0.001 --eps 0.01 --symbol nips --sample-policy recent --rms-decay 0.99 --nactor 16 --single-batch-size 5 --param-update-period 4 --eps-update-period 1000 --kv-type dist_async --easgd-update-period 0.001 --kvstore-update-period 3 --easgd-beta 0.2 --nworker ${n}"
script="python dqn_async.py -r roms/breakout.bin --replay-start-size 90 --optimizer rmspropnoncentered --lr 0.001 --eps 0.01 --symbol nips --sample-policy recent --rms-decay 0.99 --nactor 16 --single-batch-size 5 --param-update-period 4 --eps-update-period 1000 --kv-type dist_async --easgd-update-period 0.3 --nworker ${n}"
