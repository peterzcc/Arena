...
def learn(env, policy, vf, gamma, lam, timesteps_per_batch, num_timesteps,
    ...
    surr_loss = U.function(inputs, loss)
    ...
    while True:
        ...
        surr_loss_before = surr_loss(ob_no, action_na, standardized_adv_n)

        # Policy update
        do_update(ob_no, action_na, standardized_adv_n)

        surr_loss_after = surr_loss(ob_no, action_na, standardized_adv_n)
        ...
        logger.record_tabular("Surr0", surr_loss_before)
        logger.record_tabular("Surr1", surr_loss_after)
        if callback:
            callback()
        logger.dump_tabular()
        i += 1
