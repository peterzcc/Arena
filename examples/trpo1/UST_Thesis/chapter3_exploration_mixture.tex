...
The proposed policy distribution, namely Robust Concentric Gaussian Mixturen (RCGM) Policy, is a mixture of two Gaussian distributions:
\begin{align}
...
The KL-divergence of two RCGM policy do not have a closed form expression even for this special case. However, an empirical estimation of the KL-divergence can still be computed based on the training samples. Apart from that, the Wasserstein-2 distance between two RCGM policy can be given by:
