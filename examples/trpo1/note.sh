...
disprun python3.6 ~/Arena/examples/trpo1/plot.py -w50 --dir ../exp_25 ../exp_26 ../exp_27 ../exp_28 --label 3e-4 1e-3 3e-3 1e-2



local:
python3.6 pg_train.py --env flatcont2d --rl-method ACKTR_ADAM --nactor 32 --batch-size 2560 --withimg 1 --nfeat 16 --load-model 0 --kl 0.0001 --vlr 0.001 --npass 2 --loss TRAD_WASS --use-mix true
