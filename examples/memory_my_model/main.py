...
if __name__ == '__main__':
    ...
    data_shapes = {'q_data': (params.seqlen, params.batch_size),
                   ...
                   'init_memory_key': (params.batch_size, params.memory_size, params.memory_key_state_dim),
                   'init_memory_value': (params.batch_size, params.memory_size, params.memory_value_state_dim),
                   'KVMN->write_key_head:init_key_write_W_r_focus': (params.batch_size, params.num_writes, params.memory_size),
                   'KVMN->write_key_head:init_key_write_W_u_focus': (params.batch_size, params.num_writes, params.memory_size),
